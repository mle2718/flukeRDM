...
#for(x in 1:25){
  ...
  for (md in mode_draw) {
    ...
    base_outcomes0[[md]]<-readr::read_csv(file.path(here::here(paste0("Data/base_outcomes_new_VA_", x, "_", md, ".CSV")))) %>% 
...
predictions_out10<- furrr::future_map_dfr(50:55, ~get_predictions_out(.), .id = "draw")
