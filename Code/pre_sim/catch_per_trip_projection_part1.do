...
/*This code uses the MRIP data to: 
	...
	* Part A)  
		1) estimate mean harvest-, discards-, and catch-per-trip and their standard errors at the state, wave, and fishing mode level in the projection period
		...
		3) Once a mean and standard errors have been estimated for all strata, I save the file and run the "copula_loop_projection.R" in R. This file simulates random 
