...
output_dir <- "E:/Lou_projects/flukeRDM/flukeRDM_iterative_data/archive/calib_catch_draws"
...
for (s in unique(catch_draws_all$state)) {
  ...
  for (d in 1:n_draws){
    ...
    out_file <- file.path(output_dir, paste0("calib_catch_draws_", s, "_", d, ".xlsx"))
